...
// Meaning that the value has been referenced by a ZP, absolute or indirect load or store. Or it comes from or has been referenced by *
// label = *	- Done
// * = label	- TODO
// load/store	- TODO
#define MVALUE_IS_ADDRESS	(1u << 9)
